...
Pinned inputs used by v1.3.0. Noto Sans SC and Hanken Grotesk are sourced exclusively from the Google Fonts repository distributions below; regional glyph variants come from the official four-in-one Noto CJK release.
...
| Noto Sans CJK four-in-one TTF-VF | `googlefonts/noto-cjk Sans2.004 / 02_NotoSansCJK-TTF-VF.zip` (sc flavor) | `b73a1f90988d6ccc3f60ce44ee3d1e82479a92710cd49cd950950c9adab50f1e` |
