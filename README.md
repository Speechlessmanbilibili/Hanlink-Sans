...
| --- | --- | --- |
| `Hanlink-Sans-v1.1.0-Static.zip` | Nine TTF weights, Thin 100 through Black 900 | Windows, Word/Office, and applications with conservative variable-font support |
| `Hanlink-Sans-v1.1.0-Variable.zip` | One variable TTF with `wght` 100–900, default 400 | Modern browsers and applications with reliable variable-font support |
...
- The variable font is built with fontTools varLib from nine audited static masters, with a `wght` axis from 100 to 900.
